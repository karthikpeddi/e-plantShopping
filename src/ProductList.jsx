...
function ProductList({ onHomeClick }) {
    ...
    // Local state to disable / grey out buttons after adding an item.
    // The lab instructions recommend using this state variable.
        ...
        },
        {
            ...
            plants: [
                ...
                },
                {
                    ...
                    image: 'https://images.unsplash.com/photo-1611909023032-2d6b3134ecba?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
                    description: 'Aromatic plant that can help deter some insects.',
                    cost: '$20',
                },
                {
                    name: 'Catnip',
    ...
    // Keep local "addedToCart" in sync with global cart so buttons re-enable after deletes.
    useEffect(() => {
        const next = {};
            ...
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        <img src="https://cdn.pixabay.com/photo/2020/08/05/13/12/eco-5465432_1280.png" alt="Leaf logo" />
                ...
                <div style={styleObjUl}>
                    ...
                    <div>
                        <a href="#" onClick={handleCartClick} style={styleA} aria-label="Cart">
                            <h1 className="cart">
                                ...
                                {section.plants.map((plant) => {
                                    ...
                                    return (
                                        <div className="product-card" key={plant.name}>
                                            ...
                                            <div style={{ marginBottom: '10px' }}>{plant.description}</div>
